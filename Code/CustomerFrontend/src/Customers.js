...
class CustomersClient extends Component {
    ...
    constructor(props) {
        ...
        /* Getters */
        this.GovContract_getItem = this.GovContract_getItem.bind(this);
        this.GovContract_getStatus = this.GovContract_getStatus.bind(this);
    ...
    GovContract_getItem(idItem) {
        return GovContract.getItem.call(idItem);
    }
    GovContract_getStatus(idOrder) {
        return GovContract.getStatus.call(idOrder);
    }
                            ...
                            <Panel>
                                ...
                                <Panel.Body>
                                    <Tabs defaultActiveKey={1} id="uncontrolled-tab-example">
                                        <Tab eventKey={1} title="Contracts">
                                            {this.state.GovContract_blockchainRecordedItemIds.map(itemId => {
                                                let itemDetails = this.GovContract_getItem(itemId);
                                                return (
                                                    <div>
                                                        <Panel onClick={() => this.purchaseThisItem({
                                                            ...
                                                            <Panel.Heading className="pointIt" >New Order<small> Click to purchase!</small></Panel.Heading>
                                                            <Panel.Body>
